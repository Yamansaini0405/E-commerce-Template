...
const Slider = () => {
  ...
  const autoplayInterval = 2000; // 4 seconds
  ...
  return (
    <div className="relative w-[80%] h-[400px] md:h-[500px] lg:h-[380px] m-auto rounded-2xl ">
      ...
      <div className="w-full h-full overflow-hidden rounded-2xl">
        {images.map((image, index) => (
          <img
            ...
            src={image}
            alt={`Slide ${index}`}
            className={`absolute rounded-2xl w-full h-full object-cover transition-opacity duration-500 ${
